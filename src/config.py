...
def get_config(parse=True, **optional_kwargs):
    ...
    parser.add_argument('--n_epoch', type=int, default=50) # 2023.01.30 기존값 6 2024.02.24 기존값 100
    parser.add_argument('--patience', type=int, default=30) # 2023.01.30 기존값 6 2024.02.25 기존값 30
    ...
    if kwargs.data == "mosi":
        ...
        kwargs.batch_size = 32 # (Modified - 2022.12.4) 64 -> 32
